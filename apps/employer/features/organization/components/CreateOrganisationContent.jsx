...
import { Briefcase, CreditCard, Users, X } from "lucide-react";
...
const BENEFITS = [
  { Icon: Users, label: "Manage apprentices in one place" },
  { Icon: Briefcase, label: "Post jobs and track applications" },
  { Icon: CreditCard, label: "Billing and compliance, simplified" },
];
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col p-8 xl:p-10">
        ...
        <div className="my-10 xl:my-12">
          ...
          >
            Set up your company once. Everything on Gradlly, from apprentice
            tracking to job posts, connects to it automatically.
          </p>
        </div>
    ...
    <div className="flex min-h-0 flex-1 flex-col bg-white">
      ...
      <div className="shrink-0 px-6 pb-0 pt-6 sm:px-8 sm:pt-8 lg:px-8 lg:pt-10">
        ...
        <p className="mb-5 text-[13px] leading-relaxed text-neutral-500 sm:mb-6 sm:text-sm">
          Tell us about your company so we can prepare your dashboard and
          connect you to your apprentices and training providers.
        </p>
