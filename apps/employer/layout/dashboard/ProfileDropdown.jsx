      ...
      >
        <div className="relative shrink-0">
          ...
          {profileData.isOnline && (
            <span
              aria-hidden="true"
              className="absolute -bottom-0.5 -right-0.5 size-2.25 rounded-full border-2 bg-emerald-400"
        ...
        <div className="hidden min-w-0 text-left sm:block">
          ...
          <p className="mt-1.25 truncate text-2xs leading-none text-text-tertiary">
            {profileData.role}
          </p>
        </div>
            ...
            <div className="flex items-center gap-1.5">
              {profileData.isOnline && (
                <span className="flex items-center gap-1 text-[11px] font-semibold text-emerald-600">
                  <span
                    aria-hidden="true"
                    className="size-1.25 rounded-full bg-emerald-500"
                  />
                  Active
                </span>
              )}
            ...
            {profileData.stats.map((s, i) => (
              <div key={s.label} className="flex items-center gap-3">
                ...
                <div className="text-center">
                  ...
                  <p className="mt-0.75 text-[9px] font-semibold uppercase tracking-wide leading-none text-text-tertiary">
                    {s.label}
                  </p>
                </div>
              </div>
