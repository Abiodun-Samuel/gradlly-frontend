...
const notifications = [
  {
    ...
    desc: "Your React Fundamentals assessment is due in 2 days.",
    time: "1h ago",
    unread: true,
  },
  {
    ...
    desc: "Advanced TypeScript Patterns is now available.",
    time: "3h ago",
    unread: true,
  },
  {
    ...
    desc: "Your mentor left feedback on your last submission.",
    time: "1d ago",
    unread: false,
  },
];
    ...
    <div ref={ref} className="relative">
      ...
      {open && (
        <div
          ...
          className="absolute right-0 top-full z-100 mt-2 w-85 overflow-hidden rounded-2xl border border-(--color-border) bg-surface-0 animate-[dropdown-enter_150ms_ease-out_forwards]"
          style={{
            boxShadow:
        ...
        >
          <div className="flex items-center justify-between border-b border-(--color-border) px-4 py-3.5">
            ...
            <button
              ...
              className="flex size-7 items-center justify-center rounded-lg text-text-tertiary transition-colors hover:bg-surface-2"
            >
