...
const BREADCRUMBS = {
  ...
  "/builder/new": { parent: "Builder", current: "New Flow" },
  "/builder/templates": { parent: "Builder", current: "Templates" },
  ...
  "/logs/success": { parent: "Activity Logs", current: "Success Logs" },
  "/logs/error": { parent: "Activity Logs", current: "Error Logs" },
  "/logs/audit": { parent: "Activity Logs", current: "Audit Trail" },
