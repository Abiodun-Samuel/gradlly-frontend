...
const BREADCRUMBS = {
  ...
  "/courses": { parent: "Talent", current: "AI Programmes" },
  "/learners": { parent: "Talent", current: "Apprentices" },
  "/approvals": { parent: "Delivery", current: "OTJ Approvals" },
  "/commitment-statements": {
    parent: "Delivery",
    current: "Commitment Statements",
  },
  "/reviews": { parent: "Delivery", current: "Reviews" },
  "/funding": { parent: "Delivery", current: "Funding" },
  "/analytics": { parent: "Reporting", current: "SME Analytics" },
  "/reports": { parent: "Reporting", current: "SME Reports" },
  "/eligibility": { parent: "Onboarding", current: "Eligibility" },
