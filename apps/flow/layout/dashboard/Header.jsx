...
const BREADCRUMBS = {
  "/": { parent: "Workspace", current: "Dashboard" },
  "/courses": { parent: "Levy Exchange", current: "AI Programmes" },
  "/levy": { parent: "Levy Exchange", current: "Levy Surplus" },
  "/matches": { parent: "Levy Exchange", current: "Donor Matches" },
  "/transfers": { parent: "Levy Exchange", current: "Transfers" },
  "/donor-links": { parent: "Levy Exchange", current: "Donor Links" },
  "/eligibility": { parent: "Levy Exchange", current: "Eligibility" },
  "/reports": { parent: "Reporting", current: "SME Reports" },
  "/register": { parent: "Onboarding", current: "ESFA Registration" },
  "/flows": { parent: "Workspace", current: "My Flows" },
  "/builder": { parent: "Workspace", current: "Flow Builder" },
  "/connections": { parent: "Integrations", current: "Connections" },
  "/webhooks": { parent: "Integrations", current: "Webhooks" },
