...
const BENEFITS = [
  { Icon: GitBranch, label: "Build and manage flows visually" },
  { Icon: Zap, label: "Automate tasks with webhooks & triggers" },
  { Icon: Activity, label: "Monitor activity logs in real-time" },
];
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col p-8 xl:p-10">
        ...
        <div className="my-10 xl:my-12">
          ...
          >
            Set up your organisation once. Everything on Gradlly Flow, from
            connections to activity logs, links to it automatically.
          </p>
        </div>
    ...
    <div className="flex min-h-0 flex-1 flex-col bg-white">
      ...
      <div className="shrink-0 px-6 pb-0 pt-6 sm:px-8 sm:pt-8 lg:px-8 lg:pt-10">
        ...
        <p className="mb-5 text-[13px] leading-relaxed text-neutral-500 sm:mb-6 sm:text-sm">
          Tell us about your organisation so we can prepare your dashboard and
          connect your flows, integrations, and automation pipelines.
        </p>
