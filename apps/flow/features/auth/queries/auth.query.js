...
export function useLogout() {
  ...
  return useMutation({
    ...
    onError: () => {
      // Network failure — the proxy never ran so cookies may still be set.
      // We still redirect to login; the user will be re-authenticated by
      // the proxy on the next credentialed request.
