...
const notifications = [
  {
    ...
    desc: "Your Q3 milestone has been approved by your employer.",
    time: "2m ago",
    unread: true,
  },
  {
    id: 2,
    title: "New message",
    desc: "Your employer sent you a new message.",
    time: "1h ago",
    unread: true,
  },
  {
    id: 3,
    title: "OTJ reminder",
    desc: "Remember to log your off-the-job training hours.",
    time: "3h ago",
    unread: false,
  },
];
          ...
          <div className="divide-y divide-(--color-border)">
            {notifications.map((n) => (
              <div
                key={n.id}
                className={cn(
                  "flex cursor-pointer gap-3.5 px-4 py-3.5",
